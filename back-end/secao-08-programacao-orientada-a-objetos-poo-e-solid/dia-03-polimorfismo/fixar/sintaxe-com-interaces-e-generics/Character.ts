...
interface DbCharacter extends Characters {
  id: number;
}
...
interface IModel {
  create: (character: Characters) => Promise<DbCharacter>;
  update: (id: number, character: Characters) => Promise<DbCharacter>;
...
class LocalDbModel implements IModel {
  create = async (character: Characters) => {
  ...
  update = async (id: number, character: Characters) => {
...
class CharacterService {
  ...
  async create(character: Characters) {
...
class MockDbModel implements IModel {
  ...
  async update(id: number, character: Characters) {
