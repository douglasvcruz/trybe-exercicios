const readlines = require('readline-sync'); // importamos o pacote readline-sync
...
const choice = readlines.keyInSelect(scriptNames, 'Escolha um número para executar o script de conversão de unidade');
